...
Per the assignment's academic integrity policy: AI assistance (Claude) was
used to help scaffold this backend integration and debug the fetch/error-state
logic on the frontend. Full solution generation was not used blindly —
review, testing, and adjustments were done manually. Update this section
with your own honest account before submitting.
